...
Because trigonometric functions are at the heart of the symbolic calculator (see \secref{symboliccalculator}), and the calculator needs to be fast, they have to deal in rational numbers. At school, over sixty years ago, I learnt trigonometry using degrees. Later I used radians, which seem more grown-up to me. But radians are irrationals, multiples of 𝝅 a lot of the time. Using radians would mean using an extra type \verbtt{angle}, and some extra complexity. So, at the risk of seeming juvenile, degrees it is -- 45, 90, 60, all thos old friends.
